...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_END_FOR] = HAS_ESCAPES_FLAG | HAS_NO_SAVE_IP_FLAG | HAS_NO_ADVANCE_IP_FLAG,
    ...
    [_RETURN_VALUE] = HAS_NO_SAVE_IP_FLAG | HAS_NO_ADVANCE_IP_FLAG,
    [_RETURN_NONE] = HAS_NO_SAVE_IP_FLAG | HAS_NO_ADVANCE_IP_FLAG,
