...
#define HAS_NO_ADVANCE_IP_FLAG (65536)
...
#define OPCODE_HAS_NO_ADVANCE_IP(OP) (_PyOpcode_opcode_metadata[OP].flags & (HAS_NO_ADVANCE_IP_FLAG))
...
const struct opcode_metadata _PyOpcode_opcode_metadata[266] = {
    ...
    [END_FOR] = { true, INSTR_FMT_IX, HAS_ESCAPES_FLAG | HAS_NO_SAVE_IP_FLAG | HAS_NO_ADVANCE_IP_FLAG },
    ...
    [INSTRUMENTED_END_FOR] = { true, INSTR_FMT_IX, HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG | HAS_NO_SAVE_IP_FLAG | HAS_NO_ADVANCE_IP_FLAG },
    ...
    [RETURN_NONE] = { true, INSTR_FMT_IX, HAS_NO_SAVE_IP_FLAG | HAS_NO_ADVANCE_IP_FLAG },
    [RETURN_VALUE] = { true, INSTR_FMT_IX, HAS_NO_SAVE_IP_FLAG | HAS_NO_ADVANCE_IP_FLAG },
